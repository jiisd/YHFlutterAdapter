...
#import "YHFlutterFeatureChannel.h"
#import "YHFlutterProtocol.h"
#import "YHFlutterRegistrant.h"

static NSString * const kFeatureBridgeChannelName = @"yaheng.feature.flutter.bridge";

static NSString * const kFeatureInfoCallMethod = @"featureInfo";

@implementation YHFlutterFeatureChannel
...
/**
 *  @brief  该类可接收基于 FlutterMethodChannel 对应 channelName 的相关调用
 *          支持与其它 Class 重复注册相同的 channelName
 *
 ...
 *          如若有不同的类注册了相同的 channelName 以及 callMethod
 *          这些注册类都可收到对应的消息转发
 *
...
/**
 *  @brief  当前类注册了对应的 channel 之后，若 Flutter 端触发相关方法
 *          消息会被转发到此类并调用该方法
 *
